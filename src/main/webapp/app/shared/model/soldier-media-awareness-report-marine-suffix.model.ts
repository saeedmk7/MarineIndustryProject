...
export interface ISoldierMediaAwarenessReportMarineSuffix {
    id?: number;
    title?: string;
    personHour?: number;
...
export class SoldierMediaAwarenessReportMarineSuffix implements ISoldierMediaAwarenessReportMarineSuffix {
    constructor(
        public id?: number,
        public title?: string,
