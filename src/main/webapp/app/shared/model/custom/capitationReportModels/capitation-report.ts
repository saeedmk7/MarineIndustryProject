import { CapitationReportDetail } from 'app/shared/model/custom/capitationReportModels/capitation-report-detail';

export interface ICapitationReport {
    //Employees
    ...
    capitationReportDetails?: CapitationReportDetail[];
}

export class CapitationReport implements ICapitationReport {
    constructor(
        //Employees
        ...
        public capitationReportDetails?: CapitationReportDetail[]
    ) {}
}
