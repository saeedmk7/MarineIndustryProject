...
@Component({
    selector: 'mi-evaluate-criteria-training-marine-suffix',
    templateUrl: './evaluate-criteria-training-marine-suffix.component.html'
})
export class EvaluateCriteriaTrainingMarineSuffixComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll(criteria?) {
        ...
        this.evaluateCriteriaTrainingService
            .query({
                page: this.page - 1,
            ...
            .subscribe(
                (res: HttpResponse<IEvaluateCriteriaTrainingMarineSuffix[]>) =>
                    this.paginateEvaluateCriteriaTrainings(res.body, res.headers),
    ...
    clear() {
        ...
        this.router.navigate([
            '/evaluate-criteria-training-marine-suffix',
            {
                page: this.page,
                sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
            }
    ...
    ngOnInit() {
        ...
        //this.registerChangeInEvaluateCriteriaTrainings();
    }
    prepareSearchDate(){
    ...
    trackId(index: number, item: IEvaluateCriteriaTrainingMarineSuffix) {
        return item.id;
    }

    registerChangeInEvaluateCriteriaTrainings() {
        this.eventSubscriber = this.eventManager.subscribe('evaluateCriteriaTrainingListModification', response => this.loadAll());
    }
    ...
    protected paginateEvaluateCriteriaTrainings(data: IEvaluateCriteriaTrainingMarineSuffix[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.evaluateCriteriaTrainings = data;
        this.evaluateCriteriaTrainings.forEach(a => {
