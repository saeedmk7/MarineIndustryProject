...
import { EducationalModuleMarineSuffix, IEducationalModuleMarineSuffix } from 'app/shared/model/educational-module-marine-suffix.model';
...
export class PreJobNiazsanjiStepsHandlerMarineSuffixUpdateComponent implements OnInit {
    ...
    reloadStepsList(step: number) {
        ...
        this.stepsList.push(
            ...
            },
            {
                ...
                stepIndex: 2,
                activeStep: step,
                description: 'احصاء کمبود شایستگی ها'
            },
            {
                stepTitle: 'گام سوم',
                stepIndex: 3,
            ...
            },
            {
                ...
                stepIndex: 5,
                activeStep: step,
                description: 'اولویت بندی نیازسنجی شغلی'
            }
        );
    }
    ...
    updatePreJobNiazsanjiStep($event) {
        ...
        this.preJobNiazsanjiService
            .update(this.preJobNiazsanji)
            .subscribe(
                (res: HttpResponse<IPreJobNiazsanjiCompetencyMarineSuffix>) => this.onSaveSuccess(res),
