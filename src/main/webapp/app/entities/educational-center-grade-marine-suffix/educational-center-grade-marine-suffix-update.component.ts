...
export class EducationalCenterGradeMarineSuffixUpdateComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.activatedRoute.data.subscribe(({ educationalCenterGrade }) => {
            ...
            if(this.educationalCenterGrade.id !== undefined){
                ...
                this.educationalCenterGradeScoreService.query({
                    page: 0,
                    size: 20000,
                    criteria,
                    sort: ["id", "asc"]
                    ...
                    (res: HttpResponse<IEducationalCenterGradeScoreMarineSuffix[]>) => {
                        ...
                        this.buildEducationalCenterGradeScores(this.educationalCenterGradeScores, this.educationalCenterGrade.id);
                    },
    ...
    buildEducationalCenterGradeScores(educationalCenterGradeScores: IEducationalCenterGradeScoreMarineSuffix[], gradeId){
        this.educationalCenterCriteriaService.query().subscribe(
            (res: HttpResponse<IEducationalCenterCriteriaMarineSuffix[]>) => {

                this.educationalCenterCriterias = res.body.sort((a,b) => (a.displayOrder > b.displayOrder) ? 1 : (a.displayOrder < b.displayOrder) ? -1 : 0);
    ...
    sumScores(){
        const totalScore = this.educationalCenterGrade.educationalCenterGradeScores.map(a => a.score).reduce((sum, current) => sum + current);
