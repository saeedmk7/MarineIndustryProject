...
public class ImportFromExcelResource {
    ...
    public ResponseEntity<String> handleFileUpload(@Valid @RequestBody @RequestParam("file") MultipartFile file,@RequestParam("entityName") String entityName) {
        ...
        try {
             ...
             if(sb.toString().isEmpty()) {
                 ...
                 sb.append("بقیه اطلاعات فایل شما با موفقیت ثبت و درج شد.\r\n");
                 return ResponseEntity.status(HttpStatus.OK).body(sb.toString());
             }
        } catch (Exception e) {
    ...
    @GetMapping("/downloadHistoryFile/{fileName:.+}")
    public ResponseEntity<Resource> downloadHistoryFile(@PathVariable String fileName, HttpServletRequest request) {
        // Load file as Resource
        Resource resource = storageService.loadHistoryFileAsResource(fileName);
    ...
    @GetMapping("/downloadSoldierTrainingReportFile/{fileName:.+}")
    public ResponseEntity<Resource> downloadSoldierTrainingReportFile(@PathVariable String fileName, HttpServletRequest request) {
        // Load file as Resource
        Resource resource = storageService.loadSoldierTrainingReportAsResource(fileName);
    ...
    @GetMapping("/downloadSoldierMediaAwarenessReportFile/{fileName:.+}")
    public ResponseEntity<Resource> downloadSoldierMediaAwarenessReportFile(@PathVariable String fileName, HttpServletRequest request) {
        // Load file as Resource
        Resource resource = storageService.loadSoldierMediaAwarenessReportAsResource(fileName);
    ...
    @GetMapping("/downloadEvaluateCriteriaDataFile/{fileName:.+}")
    public ResponseEntity<Resource> downloadEvaluateCriteriaDataFile(@PathVariable String fileName, HttpServletRequest request) {
        // Load file as Resource
        Resource resource = storageService.loadEvaluateCriteriaDataAsResource(fileName);
    ...
    @GetMapping("/downloadEducationFile/{fileName:.+}")
    public ResponseEntity<Resource> downloadEducationFile(@PathVariable String fileName, HttpServletRequest request) {
        // Load file as Resource
        Resource resource = storageService.loadEducationFileAsResource(fileName);
    ...
    @GetMapping("/downloadJobFile/{fileName:.+}")
    public ResponseEntity<Resource> downloadJobFile(@PathVariable String fileName, HttpServletRequest request) {
        // Load file as Resource
        Resource resource = storageService.loadJobFileAsResource(fileName);
