...
public class UserService {
    ...
    @Transactional(readOnly = true)
    public Optional<User> getUserWithAuthoritiesByPersonId(Long personId) {
        return userRepository.findOneWithAuthoritiesByPersonId(personId);
    }
    ...
    public void clearUserCaches(User user) {
        ...
        Objects.requireNonNull(cacheManager.getCache(UserRepository.ALL_USERS_CACHE)).clear();
    }
}
