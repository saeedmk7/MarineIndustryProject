...
public class ConvertDateUtil extends Calendar {
    ...
    public ConvertDateUtil() {
        this(TimeZone.getDefault(), Locale.getDefault());
    }

    public ConvertDateUtil(TimeZone zone) {
        this(zone, Locale.getDefault());
    }

    public ConvertDateUtil(Locale aLocale) {
        this(TimeZone.getDefault(), aLocale);
    }

    public ConvertDateUtil(TimeZone zone, Locale aLocale) {
    ...
    public ConvertDateUtil(int year, int month, int dayOfMonth) {
        this(year, month, dayOfMonth, 0, 0, 0, 0);
    }

    public ConvertDateUtil(int year, int month, int dayOfMonth, int hourOfDay,
                          int minute) {
    ...
    ConvertDateUtil(int year, int month, int dayOfMonth,
    ...
    public static int weekOfYear(int dayOfYear, int year) {
        switch (dayOfWeek(ConvertDateUtil.jalaliToGregorian(new YearMonthDate(year, 0, 1)))) {
            case 2:
                dayOfYear++;
                break;
            case 3:
    ...
    public static class YearMonthDate {
        ...
        public String toString() {
            return getYear() + "/" + StringUtils.leftPad(String.valueOf(getMonth()), 2, '0') + "/" + StringUtils.leftPad(String.valueOf(getDate()),2,'0');
        }
    }
}
