...
/**
 * Criteria class for the NiazsanjiPersonGrade entity. This class is used in NiazsanjiPersonGradeResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /niazsanji-person-grades?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class NiazsanjiPersonGradeCriteria implements Serializable {
    /**
    ...
    public boolean equals(Object o) {
        ...
        final NiazsanjiPersonGradeCriteria that = (NiazsanjiPersonGradeCriteria) o;
        return
    ...
    public String toString() {
        return "NiazsanjiPersonGradeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
