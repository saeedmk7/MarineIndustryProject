...
/**
 * Criteria class for the LevelThreeScore entity. This class is used in LevelThreeScoreResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /level-three-scores?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LevelThreeScoreCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final LevelThreeScoreCriteria that = (LevelThreeScoreCriteria) o;
        return
    ...
    public String toString() {
        return "LevelThreeScoreCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
