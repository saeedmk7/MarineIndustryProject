...
/**
 * A DTO for the LevelFourEffectiveness entity.
 */
public class LevelFourEffectivenessDTO implements Serializable {
    ...
    private Set<LevelFourScoreDTO> levelFourScores = new HashSet<>();
    ...
    public boolean equals(Object o) {
        ...
        LevelFourEffectivenessDTO levelFourEffectivenessDTO = (LevelFourEffectivenessDTO) o;
        if (levelFourEffectivenessDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), levelFourEffectivenessDTO.getId());
    }
    ...
    public String toString() {
        return "LevelFourEffectivenessDTO{" +
            "id=" + getId() +
            ", title='" + getTitle() + "'" +
    ...
    public Set<LevelFourScoreDTO> getLevelFourScores() {
        return levelFourScores;
    }

    public void setLevelFourScores(Set<LevelFourScoreDTO> levelFourScores) {
