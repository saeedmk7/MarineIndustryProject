...
/**
 * Criteria class for the ApplicationProcessStep entity. This class is used in ApplicationProcessStepResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /application-process-steps?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ApplicationProcessStepCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final ApplicationProcessStepCriteria that = (ApplicationProcessStepCriteria) o;
        return
    ...
    public String toString() {
        return "ApplicationProcessStepCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
