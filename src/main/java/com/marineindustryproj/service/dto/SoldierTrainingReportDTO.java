...
/**
 * A DTO for the SoldierTrainingReport entity.
 */
public class SoldierTrainingReportDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        SoldierTrainingReportDTO soldierTrainingReportDTO = (SoldierTrainingReportDTO) o;
        if (soldierTrainingReportDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), soldierTrainingReportDTO.getId());
    }
    ...
    public String toString() {
        return "SoldierTrainingReportDTO{" +
            "id=" + getId() +
            ", title='" + getTitle() + "'" +
