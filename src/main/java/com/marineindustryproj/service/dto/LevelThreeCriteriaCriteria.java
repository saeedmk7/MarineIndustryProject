...
/**
 * Criteria class for the LevelThreeCriteria entity. This class is used in LevelThreeCriteriaResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /level-three-criteria?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LevelThreeCriteriaCriteria implements Serializable {
    ...
    private LongFilter levelThreeScoreId;

    private LongFilter mahiatCourseId;

    private LongFilter levelThreeCriteriaGroupId;
    ...
    public LongFilter getLevelThreeScoreId() {
        return levelThreeScoreId;
    }

    public void setLevelThreeScoreId(LongFilter levelThreeScoreId) {
        this.levelThreeScoreId = levelThreeScoreId;
    }
    ...
    public LongFilter getLevelThreeCriteriaGroupId() {
        return levelThreeCriteriaGroupId;
    }

    public void setLevelThreeCriteriaGroupId(LongFilter levelThreeCriteriaGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        final LevelThreeCriteriaCriteria that = (LevelThreeCriteriaCriteria) o;
        return
            ...
            Objects.equals(levelThreeScoreId, that.levelThreeScoreId) &&
            Objects.equals(mahiatCourseId, that.mahiatCourseId) &&
            Objects.equals(levelThreeCriteriaGroupId, that.levelThreeCriteriaGroupId);
    }
    ...
    public int hashCode() {
        ...
        levelThreeScoreId,
        mahiatCourseId,
        levelThreeCriteriaGroupId
        );
    }

    @Override
    public String toString() {
        return "LevelThreeCriteriaCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                ...
                (levelThreeScoreId != null ? "levelThreeScoreId=" + levelThreeScoreId + ", " : "") +
                (mahiatCourseId != null ? "mahiatCourseId=" + mahiatCourseId + ", " : "") +
                (levelThreeCriteriaGroupId != null ? "levelThreeCriteriaGroupId=" + levelThreeCriteriaGroupId + ", " : "") +
            "}";
    }
