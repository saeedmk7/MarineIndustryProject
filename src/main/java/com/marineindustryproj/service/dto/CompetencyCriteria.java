...
/**
 * Criteria class for the Competency entity. This class is used in CompetencyResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /competencies?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CompetencyCriteria implements Serializable {
    ...
    private IntegerFilter competencyType;
    ...
    public IntegerFilter getCompetencyType() {
        return competencyType;
    }

    public void setCompetencyType(IntegerFilter competencyType) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(competencyType, that.competencyType) &&
    ...
    public String toString() {
        return "CompetencyCriteria{" +
                ...
                (competencyType != null ? "competencyType=" + competencyType + ", " : "") +
