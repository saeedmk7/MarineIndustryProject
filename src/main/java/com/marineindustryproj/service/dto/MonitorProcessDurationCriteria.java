...
/**
 * Criteria class for the MonitorProcessDuration entity. This class is used in MonitorProcessDurationResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /monitor-process-durations?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MonitorProcessDurationCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final MonitorProcessDurationCriteria that = (MonitorProcessDurationCriteria) o;
        return
    ...
    public String toString() {
        return "MonitorProcessDurationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
