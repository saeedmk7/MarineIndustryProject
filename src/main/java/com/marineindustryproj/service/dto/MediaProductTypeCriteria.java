...
/**
 * Criteria class for the MediaProductType entity. This class is used in MediaProductTypeResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /media-product-types?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MediaProductTypeCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final MediaProductTypeCriteria that = (MediaProductTypeCriteria) o;
        return
    ...
    public String toString() {
        return "MediaProductTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
