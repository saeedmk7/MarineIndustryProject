...
/**
 * Criteria class for the SoldierTrainingReport entity. This class is used in SoldierTrainingReportResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /soldier-training-reports?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class SoldierTrainingReportCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final SoldierTrainingReportCriteria that = (SoldierTrainingReportCriteria) o;
        return
    ...
    public String toString() {
        return "SoldierTrainingReportCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
