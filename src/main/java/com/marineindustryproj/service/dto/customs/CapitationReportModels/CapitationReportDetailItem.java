...
public class CapitationReportDetailItem {

    private long groupId;
    private String groupTitle;
    private String industryTitle;
    private List<Long> organizationChartIds;
    //Employees
    ...
    private CapitationReportDetail capitationReportDetail;
    ...
    public List<Long> getOrganizationChartIds() {
        return organizationChartIds;
    }

    public void setOrganizationChartIds(List<Long> organizationChartIds) {
        this.organizationChartIds = organizationChartIds;
    }
    ...
    public CapitationReportDetail getCapitationReportDetail() {
        return capitationReportDetail;
    }

    public void setCapitationReportDetail(CapitationReportDetail capitationReportDetail) {
        this.capitationReportDetail = capitationReportDetail;
    }
}
