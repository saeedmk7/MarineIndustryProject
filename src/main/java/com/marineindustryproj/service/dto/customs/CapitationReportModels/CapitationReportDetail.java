...
public class CapitationReportDetail {
    ...
    private CapitationReport capitationReport;
    private List<CapitationReportDetailItem> capitationReportDetailItems;
    ...
    public CapitationReport getCapitationReport() {
        return capitationReport;
    }

    public void setCapitationReport(CapitationReport capitationReport) {
        this.capitationReport = capitationReport;
    }

    public List<CapitationReportDetailItem> getCapitationReportDetailItems() {
        return capitationReportDetailItems;
    }

    public void setCapitationReportDetailItems(List<CapitationReportDetailItem> capitationReportDetailItems) {
        this.capitationReportDetailItems = capitationReportDetailItems;
    }
}
