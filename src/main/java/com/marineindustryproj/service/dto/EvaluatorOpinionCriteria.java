...
/**
 * Criteria class for the EvaluatorOpinion entity. This class is used in EvaluatorOpinionResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /evaluator-opinions?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EvaluatorOpinionCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final EvaluatorOpinionCriteria that = (EvaluatorOpinionCriteria) o;
        return
    ...
    public String toString() {
        return "EvaluatorOpinionCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
