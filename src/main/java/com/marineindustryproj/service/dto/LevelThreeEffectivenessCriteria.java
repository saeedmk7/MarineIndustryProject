...
/**
 * Criteria class for the LevelThreeEffectiveness entity. This class is used in LevelThreeEffectivenessResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /level-three-effectivenesses?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LevelThreeEffectivenessCriteria implements Serializable {
    /**
    ...
    public boolean equals(Object o) {
        ...
        final LevelThreeEffectivenessCriteria that = (LevelThreeEffectivenessCriteria) o;
        return
    ...
    public String toString() {
        return "LevelThreeEffectivenessCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
