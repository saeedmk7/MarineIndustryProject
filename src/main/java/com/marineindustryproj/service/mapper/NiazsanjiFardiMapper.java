 ...
 */
@Mapper(componentModel = "spring", uses = {DocumentMapper.class, CourseTypeMapper.class, RequestNiazsanjiFardiMapper.class, EducationalModuleMapper.class, PersonMapper.class, OrganizationChartMapper.class})
