...
public class RequestOrganizationNiazsanji implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "request_organization_niazsanji_restriction",
               joinColumns = @JoinColumn(name = "request_organization_niazsanjis_id", referencedColumnName = "id"),
    ...
    public RequestOrganizationNiazsanji restrictionDescription(String restrictionDescription) {
    ...
    public RequestOrganizationNiazsanji goalsText(String goalsText) {
    ...
    public RequestOrganizationNiazsanji prerequisite(String prerequisite) {
    ...
    public RequestOrganizationNiazsanji restrictions(Set<Restriction> restrictions) {
        this.restrictions = restrictions;
        return this;
    }

    public RequestOrganizationNiazsanji addRestriction(Restriction restriction) {
        this.restrictions.add(restriction);
        restriction.getRequestOrganizationNiazsanjis().add(this);
        return this;
    }

    public RequestOrganizationNiazsanji removeRestriction(Restriction restriction) {
        this.restrictions.remove(restriction);
        restriction.getRequestOrganizationNiazsanjis().remove(this);
        return this;
    }
    ...
    public RequestOrganizationNiazsanji teachingApproach(TeachingApproach teachingApproach) {
